// function OurImpact() {
//   return (
//     <div className="min-h-screen relative  bg-[#24a69a] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-inter text-white">
//       <img
//         src="images/ourMissionImg.png"
//         alt="Katmandu"
//         className="w-full absolute  mt-70 item-baseline object-contain rounded "
//       />
  ...
  return (
    <div className="min-h-screen relative bg-[#24a69a] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-inter text-white">
      ...
      <img
        src="images/ourMissionImg.png"
        alt="Katmandu"
        className="w-full absolute bottom-0 object-contain rounded"
      />
